...
<body class="app header-fixed sidebar-fixed aside-menu-fixed aside-menu-hidden">
    ...
    <footer class="app-footer">
        <a href="http://www.medust.com">Medust Technology</a> © 2017 creativeLabs.
        <span class="float-right">Powered by <a href="http://www.medust.com">Medust Technology Pvt. Ltd.</a>
        </span>
    </footer>

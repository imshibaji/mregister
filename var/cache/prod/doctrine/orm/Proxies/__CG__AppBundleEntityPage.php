...
class Page extends \AppBundle\Entity\Page implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Page' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Page' . "\0" . 'title', '' . "\0" . 'AppBundle\\Entity\\Page' . "\0" . 'keyword', '' . "\0" . 'AppBundle\\Entity\\Page' . "\0" . 'description', '' . "\0" . 'AppBundle\\Entity\\Page' . "\0" . 'content'];
        }

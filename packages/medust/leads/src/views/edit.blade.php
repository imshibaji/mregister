      ...
      <div class="row">
        <div class="col-md-6">
          ...
          <div class="input-group">
            ...
            <input type="text" class="form-control" name="name" id="name" value="{{ $lead->user->name }}" required>
          </div>
          <label for="mobile">Mobile Numbers**</label>
          <div class="input-group">
            <span class="input-group-addon" id="basic-addon3">Mobile No</span>
            <input type="text" class="form-control" name="mobile" id="mobile" value="{{ $lead->user->mobile }}" required>
          </div>
          <label for="email">Email Address</label>
          <div class="input-group">
            <span class="input-group-addon" id="basic-addon3">Email ID</span>
            <input type="text" class="form-control" id="email" name="email" value="{{ $lead->user->email }}">
          </div>
        ...
        <div class="col-md-6">
          ...
          <div class="input-group">
            ...
            <input type="text" class="form-control" name="address" id="address" value="{{ $lead->user->address }}">
          </div>
